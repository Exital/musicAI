"""
Django settings for rocket_webapp project.
...
print(load_dotenv(os.path.join(project_folder, '.env')))
...
ROOT_URLCONF = 'rocket_webapp.urls'
...
WSGI_APPLICATION = 'rocket_webapp.wsgi.application'
